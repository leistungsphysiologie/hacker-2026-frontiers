...
During manuscript preparation R version 4.5.2 was used. Package versions are managed via [`renv`](https://rstudio.github.io/renv).  
To restore the exact environment and reproduce the figures:
